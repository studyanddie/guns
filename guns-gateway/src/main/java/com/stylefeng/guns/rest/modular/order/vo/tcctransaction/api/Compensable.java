package com.stylefeng.guns.rest.modular.order.vo.tcctransaction.api;
    ...
    class DefaultTransactionContextEditor implements TransactionContextEditor {
        ...
        public static int getTransactionContextParamPosition(Class<?>[] parameterTypes) {
            ...
            for (int i = 0; i < parameterTypes.length; i++) {
                if (parameterTypes[i].equals(com.stylefeng.guns.rest.modular.order.vo.tcctransaction.api.TransactionContext.class)) {
                    position = i;
                    break;
                }
            }
        ...
        public static TransactionContext getTransactionContextFromArgs(Object[] args) {
            ...
            for (Object arg : args) {
                if (arg != null && com.stylefeng.guns.rest.modular.order.vo.tcctransaction.api.TransactionContext.class.isAssignableFrom(arg.getClass())) {

                    transactionContext = (com.stylefeng.guns.rest.modular.order.vo.tcctransaction.api.TransactionContext) arg;
                }
            }
